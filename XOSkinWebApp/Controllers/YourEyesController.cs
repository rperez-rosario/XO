  ...
  public class YourEyesController : Controller
  {
    ...
    public IActionResult Index()
    {
      ...
      product = _context.Products.Where(
        ...
        x => x.ProductType == 2).Where( // 2 = "Eye Serum."
      ...
      ViewData.Add("YourEyes.WelcomeText", _context.LocalizedTexts.Where(
        x => x.PlacementPointCode.Equals("YourEyes.WelcomeText")).Select(x => x.Text).FirstOrDefault());
